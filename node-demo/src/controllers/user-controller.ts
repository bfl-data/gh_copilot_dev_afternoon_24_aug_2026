// Reference state: this is the "well-shaped" controller. It follows the
// conventions described in prepared/copilot-instructions.md and is opened
// as a context tab during Module 3.1 (Before / After instructions demo).
// Do NOT modify this file before the session.
