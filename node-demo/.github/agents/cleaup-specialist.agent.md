---
name: Cleaup Specialist
description: This agent will make code more maintainable
argument-hint: Ask the agent to improve code quality quality on a input file.
